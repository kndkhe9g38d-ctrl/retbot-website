...
function applyLoginLocale(){
  ...
  $("#loginNote").textContent=state.locale==="ar"?"التوكن يبقى داخل السيرفر ولا يظهر للموقع.":"Your bot token stays on the server and is never exposed to the website.";
}
function bindLogin(){
  $("#loginBtn").onclick=()=>{
